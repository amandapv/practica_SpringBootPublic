package com.example.votacion_pelicula_fav;
...
public class HomeController {
    ...
    private List<Integer> listadoFotos = new ArrayList<>(Arrays.asList(0, 0, 0)); //inicializo un array que almacenará la votación de cada foto. Lo pongo fuera del siguiente método para que no se inicialice a 0 cada vez que vaya a la votación 
