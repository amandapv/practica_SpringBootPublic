...
public class Influencer {
    ...
    @Id //marca el campo "id" como Clave Primaria (PK) para distinguir un influencer de otro
    @GeneratedValue (strategy = GenerationType.IDENTITY)
    private Long id;

    @NotBlank(message = "El nombre no puede estar vacío") //le puse notBlanck ya que no permite ni null ni "" ni " "
    private String nombreInsta;
